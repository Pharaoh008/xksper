...
export type PluginNodeType = Node<PluginNodeData, 'plugin'>;

export function PluginNode(props: NodeProps<PluginNodeType>) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="px-3 py-2 bg-[#faf5ff] border-b border-[#e8efff]">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded bg-[#8b5cf6]">
      ...
      <Handle
        ...
        className="!w-3 !h-3 !bg-[#8b5cf6] !border-2 !border-white"
      />
      <Handle
        type="source"
